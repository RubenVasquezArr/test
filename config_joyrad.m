% Configuration file to run data processing for joyrad94,
...
% define input data path - structer in selected folder should be
...
config.metadatafile = 'outputmeta_joyrad94_ac3';
