...
config.title = {'JOYRAD-94 measurements at AWIPEV, Ny-Ålesund', ...
                'Doppler spectra for JOYRAD-94 measurements at AWIPEV, Ny-Ålesund', ...
                'Housekeeping data for JOYRAD-94 measurements at AWIPEV, Ny-Ålesund'};
...
config.source = 'JOYRAD-94 cloud radar';%'RPG-FMCW-94-SP';
...
config.references  = 'Gierens et al., in preparation for ESSD; Küchler et al. (2017) https://doi.org/10.1175/JTECH-D-17-0019.1'; % mirac also Mech et al
...
config.pi          = 'Kerstin Ebell; University of Cologne, Germany; kebell@meteo.uni-koeln.de';       
config.author      = 'Rosa Gierens; University of Cologne, Germany; rgierens@uni-koeln.de';       
config.project     = '(AC)3';
