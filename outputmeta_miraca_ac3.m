...
config.title = {'MiRAC-A measurements at AWIPEV, Ny-Ålesund', ...
                'Doppler spectra for MiRAC-A measurements at AWIPEV, Ny-Ålesund', ...
                'Housekeeping data for MiRAC-A measurements at AWIPEV, Ny-Ålesund'};
