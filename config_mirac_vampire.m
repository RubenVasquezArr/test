...
config.datapath = '/data/obs/campaigns/vampire/mirac-a/raw_rpg';
...
config.outputpath = '/data/obs/campaigns/vampire/mirac-a/l1';
...
config.metadatafile = 'outputmeta_miraca_vampire';
...
%   example: JOYCE = joy
%   example: Polarstern, VAMPIRE = pol
config.nickstation = 'pol';
